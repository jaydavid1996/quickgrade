<ul class="sidebar navbar-nav">
  <li class="nav-item  <?= isset($active_nav)&&($active_nav=='users')?'active':'' ?>">
  ...
  <li class="nav-item <?= isset($active_nav)&&($active_nav=='exams')?'active':'' ?>">
  ...
  <li class="nav-item  <?= isset($active_nav)&&($active_nav=='classes')?'active':'' ?>">
    <a class="nav-link" href="<?= $this->Url->build(['controller'=>'pages','action'=>'classes']); ?>">
      <i class="fas fa-fw fa-chart-area"></i>
      <span>Class</span></a>
  </li>
  <li class="nav-item  <?= isset($active_nav)&&($active_nav=='students')?'active':'' ?>">
    <a class="nav-link" href="<?= $this->Url->build(['controller'=>'pages','action'=>'students']); ?>">
      <i class="fas fa-fw fa-table"></i>
      <span>Student</span></a>
  </li>
  <li class="nav-item  <?= isset($active_nav)&&($active_nav=='pages')?'active':'' ?>">
